...
>>>>>>> f41bb56b587b5335f67b99abbb779a357c363e8d
...
>>>>>>> f41bb56b587b5335f67b99abbb779a357c363e8d
   ...
   <button type="submit" class="p-2.5 ms-2 mr-2 mt-2 text-sm font-medium text-white bg-green-600 rounded-lg border border-green-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
...
=======
                        ...
                        >
                          <li>
                            <a
                              href="#"
                              class="block px-4 py-2 hover:bg-gray-100 hover:bg-gray-600 text-gray-200 hover:text-white"
                            >
                              AIESEC
                            </a>
                          </li>
...
<<<<<<< HEAD
              ...
              <li class="mr-0">
              <a href="/Sign-in"><button type="button" class="text-white bg-green-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-1.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mr-0">
                Login
              </button></a>
...
=======
              ...
              <li class="mr-0">
                <a href="/SignIn">
                  <button
                    type="button"
                    class="text-white bg-green-600 hover:green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-1.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mr-0"
                  >
                    Login
                  </button>
                </a>
