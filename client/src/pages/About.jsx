...
export default function About() {
  ...
  const data = [
    ...
    },
    {
      ...
      icon2: '<i onclick="window.open(\'https://www.instagram.com/rashminda_jc/\', \'_blank\')" class="fa-brands fa-instagram fa-2x colour"></i>',
      icon3: '<i onclick="window.open(\'https://www.linkedin.com/in/chamindu-rashminda-42565828a\', \'_blank\')" class="fa-brands fa-linkedin fa-2x colour"><a href="" ></i>'
    }
  ];
  ...
  const data2 = [
    ...
    },
    {
      ...
      img: pro6,
      review: `Software Engineering Undergraduate`,
      icon1: '<i onclick="window.open( \'https://github.com/K-M-PERERA\',\'_blank\')" class="fa-brands fa-github fa-2x colour"></i>',
      icon2: '<i onclick="window.open( \'https://www.instagram.com/kalindu_malika\',\'_blank\')" class="fa-brands fa-instagram fa-2x colour"></i>',
      icon3: '<i onclick="window.open( \'\'https://www.linkedin.com/in/kalindu-malika-1746a4295\', \'_blank\')" class="fa-brands fa-linkedin fa-2x colour"><a href="" ></i>'
    }
  ];
  ...
  return (
    <div className="bod mb-10">
      ...
      <section className="bg-center bg-no-repeat bg-[url(src/images/aboutslider.jpg)] bg-gray-700 bg-blend-multiply mt-12">
      ...
      <div className="nsbm  pt-10 mt-3 mb-5 flex justify-center items-center" >
        <div className="nsbm-txt  p-10  ml-20 mr-20">
          ...
          <div className="icons mt-5  flex justify-center items-center">
            <i className="fa-solid fa-globe fa-2x mr-3" onClick={() => window.open("https://www.nsbm.ac.lk/", "_blank")} ></i>
            <i className="fa-solid fa-location-dot fa-2x mr-3" onClick={() => window.open("https://maps.app.goo.gl/GSPJD3Uozh4mXSDV8", "_blank")}></i>
            <i className="fa-brands fa-linkedin fa-2x mr-3" onClick={() => window.open("https://www.linkedin.com/school/nsbmgreenuniversity", "_blank")} ></i>
            <i className="fa-brands fa-facebook fa-2x " onClick={() => window.open("https://web.facebook.com/nsbm.lk", "_blank")} ></i>
          </div>
        </div>
      </div>
      <div className="nsbm pt-10 mt-3 mb-5 flex justify-center items-center w-full" >
        <iframe className="w-3/4 shadow-xl" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.5757963152946!2d80.03899797448226!3d6.821334419631726!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae2523b05555555%3A0x546c34cd99f6f488!2sNSBM%20Green%20University!5e0!3m2!1sen!2slk!4v1710687260967!5m2!1sen!2slk" width="600" height="450" style={{ border: 0 }} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
      </div>

      <section className="container">
        <div className="slider-wrapper">
          <div className="slider" ref={sliderRef}>
            <img id="slide-1" src={s1} alt="NSBM front gate" style={{ display: currentSlide === 1 ? "block" : "none" }} />
            <img id="slide-2" src={s2} alt="nsbm front" style={{ display: currentSlide === 2 ? "block" : "none" }} />
            <img id="slide-3" src={s3} alt="nsbm swimming pool" style={{ display: currentSlide === 3 ? "block" : "none" }} />
            <img id="slide-4" src={s4} alt="nsbm ground 1" style={{ display: currentSlide === 4 ? "block" : "none" }} />
          </div>
