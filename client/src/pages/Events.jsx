        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
          {events.map((event) => (
            <div key={event.id} className="rounded overflow-hidden shadow-lg flex flex-col">
              ...
              <a href={event.participateLink} target="_blank" rel="noopener noreferrer" className="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800">participate</a>
