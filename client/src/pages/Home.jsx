...
<section class="bg-white dark:bg-gray-900">
    ...
    <div class="w-64 h-80 bg-white border border-gray-200 rounded-lg shadow bg-gray-800 dark:border-gray-700 mb-4 md:mb-0">
        ...
        <div class="p-5">
            <a href="/clubs">
                <h5 class="mb-2 text-2xl tracking-tight text-gray-900 dark:text-white">FOC Clubs & Societies</h5>
            </a>
    ...
    <div class="w-64 h-80 bg-white border border-gray-200 rounded-lg shadow bg-gray-800 dark:border-gray-700 mb-4 lg:ml-12 md:mb-0">
        ...
        <div class="p-5">
            <a href="#">
                <h5 class="mb-2 text-2xl tracking-tight text-gray-900 dark:text-white">FOB Clubs & Societies</h5>
            </a>
            {/* <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p> */}
    ...
    <div class="w-64 h-80 bg-white border border-gray-200 rounded-lg shadow bg-gray-800 dark:border-gray-700 mb-4 lg:ml-12 md:mb-0">
        ...
        <div class="p-5">
            <a href="#">
                <h5 class="mb-2 text-2xl tracking-tight text-gray-900 dark:text-white">FOE Clubs & Societies</h5>
            </a>
            {/* <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p> */}
            <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                Explore Now
